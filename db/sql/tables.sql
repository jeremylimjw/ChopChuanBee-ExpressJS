...
CREATE TABLE IF NOT EXISTS employees(
    ...
    role_id         INTEGER REFERENCES roles_enum(role_id) NOT NULL,
    created_at      TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

CREATE TABLE IF NOT EXISTS access_rights(
    ar_id           SERIAL PRIMARY KEY,
    emp_id          VARCHAR(255) REFERENCES employees(emp_id) NOT NULL,
    view_id         INTEGER REFERENCES views_enum(view_id) NOT NULL,
